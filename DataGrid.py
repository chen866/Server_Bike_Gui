...
class DataGrid(QWidget):
	...
	def __init__(self,  input_num):
		super().__init__()
		self.setWindowTitle("管理员信息查询，按号查找")
	...
	def setTableView(self):	
		...
		self.db.setPassword("xxxxxxxxxx")
	...
	def getTotalRecordCount(self):			
		self.queryModel.setQuery("select id, name,passwd,telenum,email from admin where id = %s"%(self.input_num))
	...
	def recordQuery(self, limitIndex ):	
		szQuery = ("select id, name,passwd,telenum,email from admin  where id=%s limit %d,%d" % (   self.input_num,  limitIndex , self.PageRecordCount ) )
