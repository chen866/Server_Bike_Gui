...
class DataGridBike(QWidget):

	def __init__(self):
		super().__init__()
		self.setWindowTitle("单车信息管理")
	...
	def getTotalRecordCount(self):			
		self.queryModel.setQuery("select id,category,lat,lon,state from bike_info")
	...
	def recordQuery(self, limitIndex ):	
		szQuery = ("select id,category,lat,lon,state from bike_info  limit %d,%d" % (  limitIndex , self.PageRecordCount ) )
