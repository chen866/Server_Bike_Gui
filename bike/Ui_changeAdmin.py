...
# Form implementation generated from reading ui file 'D:\Server_Bike_Gui\bike\changeAdmin.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.SpanningRole, self.label_6)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "单车信息修改（按号查询）"))
        self.label_2.setText(_translate("Form", "单车号"))
        self.label_4.setText(_translate("Form", "维度位置"))
        self.label_5.setText(_translate("Form", "单车状态"))
        self.label_3.setText(_translate("Form", "经度位置"))
        self.label_6.setText(_translate("Form", "单车状态设置中  1 为已上锁，可用     0为已开启，不可用"))
