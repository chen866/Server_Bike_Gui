...
class DataGrid(QWidget):
	...
	def getTotalRecordCount(self):			
		self.queryModel.setQuery("select * from order_info where id = %s"%(self.input_num))
	...
	def recordQuery(self, limitIndex ):	
		szQuery = ("select * from order_info  where id=%s limit %d,%d" % (   self.input_num,  limitIndex , self.PageRecordCount ) )
