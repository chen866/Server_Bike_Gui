...
class DataGridOrder3(QWidget):

	def __init__(self):
		super().__init__()
		self.setWindowTitle("订单信息查询")
	...
	def getTotalRecordCount(self):			
		self.queryModel.setQuery("select * from order_info")
	...
	def recordQuery(self, limitIndex ):	
		szQuery = ("select * from order_info limit %d,%d" % (   limitIndex , self.PageRecordCount ) )
