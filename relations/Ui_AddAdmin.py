...
# Form implementation generated from reading ui file 'D:\Server_Bike_Gui\relations\AddAdmin.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_6.setGeometry(QtCore.QRect(160, 350, 441, 16))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_5.setText(_translate("Form", "添加租赁关系"))
        self.label.setText(_translate("Form", "用户编号："))
        self.label_2.setText(_translate("Form", "自行车编号："))
        self.label_3.setText(_translate("Form", "下单时间："))
        self.label_4.setText(_translate("Form", "结账时间："))
        self.pushButton.setText(_translate("Form", "确认"))
        self.pushButton_2.setText(_translate("Form", "取消"))
        self.label_6.setText(_translate("Form", "标准的时间输入格式为  2018-04-22 23:10   24小时制"))
