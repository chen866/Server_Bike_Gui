...
class DataGrid(QWidget):
	...
	def __init__(self,  input_num):
		super().__init__()
		self.setWindowTitle("用户信息查询，按号查找")
	...
	def getTotalRecordCount(self):			
		self.queryModel.setQuery("select * from user_info where id = %s"%(self.input_num))
	...
	def recordQuery(self, limitIndex ):	
		szQuery = ("select * from user_info  where id=%s limit %d,%d" % (   self.input_num,  limitIndex , self.PageRecordCount ) )
