...
class DataGridUser3(QWidget):

	def __init__(self):
		super().__init__()
		self.setWindowTitle("用户信息查询")
	...
	def getTotalRecordCount(self):			
		self.queryModel.setQuery("select * from user_info")
	...
	def recordQuery(self, limitIndex ):	
		szQuery = ("select * from user_info limit %d,%d" % (   limitIndex , self.PageRecordCount ) )
