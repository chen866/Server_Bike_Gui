...
# Form implementation generated from reading ui file 'D:\Server_Bike_Gui\user\changeAdmin.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "用户信息修改（按号查询）"))
        self.label_2.setText(_translate("Form", "用户号"))
        self.label_4.setText(_translate("Form", "用户电话"))
        self.label_5.setText(_translate("Form", "用户邮箱"))
