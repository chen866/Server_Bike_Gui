...
# Form implementation generated from reading ui file 'D:\Server_Bike_Gui\user\deleteAdminByNum.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "按用户号删除用户"))
        self.label_2.setText(_translate("Dialog", "用户号："))
